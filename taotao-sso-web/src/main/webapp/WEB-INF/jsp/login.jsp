...
<div class="w">
    <div id="logo">
    	...
    	<a href="http://localhost:8082" clstag="passport|keycount|login|01">
    		<img src="http://www.zzlhs.club/testFtp1.jpg" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
        ...
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                ...
                <div class="item login-btn2013">
                    <input type="button" class="btn-img btn-entry" id="loginsubmit" value="登录" tabindex="8" clstag="passport|keycount|login|06">登录</input>
                </div>
            </div>
        </div>
